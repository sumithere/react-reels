...
import TextLink from './Textlink';
import { Container, Button, IconButton, Grid, makeStyles, Card, Paper, CardActionArea, CardActions, CardMedia, TextField, Typography } from '@material-ui/core';
        ...
        <Grid container style={{ justifyContent: "center" }} >
            <Grid item xs={8} sm={6} md={4}>
                ...
                <Button size="large" style={{ width: "25rem", alignItems: "center" }}>{<div style={{ display: "flex" }}>
                    <Typography paragraph={true} variant="overline" display="block" style={{ textAlign: "center" }}>Have an account?</Typography>
